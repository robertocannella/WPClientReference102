<?php
/**
 * Plugin Name: BKJ Client Reference w/ React Search
 * Plugin URI: http://stevegrunwell.com/wp-client-reference
 * Description: Create a reference guide for clients right in the WordPress administration area. Customized for BKJ Productions clients.
 * Version: 1.0.2
 ...
 * @version 0.5
 * Version history
 1.0.1 so it will not try to autoupdate!
 added "static" around line 209:
   public static function get_default_settings() {

 0.5.1 revisions 2023-04-12
 Add sorting and better display
 */
...
class WP_Client_Reference {
  ...
  public function get_breadcrumbs() {
    ...
    $breadcrumbs = array( sprintf( '<li><a href="?page=wpclientref_articles">%s</a></li>', __( 'KB Index', 'wpclientref' ) ) );
